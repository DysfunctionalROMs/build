...
""" % bcb_dev)
  ...
  script.Print(" ************************************************)((_))  ")
  script.Print(" ***********************************************((_)_()  ")
  script.Print(" \______   \______**____*|  |*__*____***____ ***|\ .__\  ")
  script.Print(" *|    |  _|_  __ \/  _ \|  |/ // __ \ /    \***|;|.   | ")
  script.Print(" *|    |   \|  | \(  <_> )    <\  ___/|   |  \**| |   :| ")
  script.Print(" *|______  /|__|   \____/|__|_ \\___  >___|  /***\|:___| ")
  script.Print(" ***_____\/*******************\.__  \/.__  \/*********   ")
  script.Print(" **/     \ _____ _______  _____|  |__ |__| ____***______ ")
  script.Print(" */  \ /  \\__  \\_  __ \/  ___/  |  \|  |/ __ \ /  ___/ ")
  script.Print(" /    Y    \/ __ \|  | \/\___ \|   Y  \  \  ___/ \___ \  ")
  script.Print(" \____|__  (____  /__|  /____  >___|  /__|\___  >____  > ")
  script.Print("         \/     \/           \/     \/        \/     \/  ")
